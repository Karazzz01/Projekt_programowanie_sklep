...
public class SklepKategorieProdukty {
    ...
    public static void edycjaProducenta(){
        Scanner scaner = new Scanner(System.in);
        System.out.println("Podaj podaj id producenta:");
    ...
    public static void edycjaKategori(){
        ...
        int id = scaner.nextInt();
        scaner.nextLine();
        System.out.println("Podaj nową nazwę kategori:");
        String kategoria = scaner.nextLine();
    ...
    public static void usunKategorie(){
        Scanner scaner = new Scanner(System.in);
        int sterowanie;
        System.out.println("Podaj id kategori do usunięcia: ");
        int id = scaner.nextInt();
        scaner.nextLine();
        System.out.println("Usunięcie kategori spowoduje usunięcie powiazanych z nia produktów");
        String decyzja;
        do{
            sterowanie = 0;
    ...
    public static void usunProducent(){
        ...
        int id = scaner.nextInt();
        scaner.nextLine();
        System.out.println("Usunięcie producenta spowoduje usunięcie powiazanych z nia produktów");
        String decyzja;
        do{
            sterowanie = 0;
